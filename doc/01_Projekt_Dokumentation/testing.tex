...
\begin{center}
	...
	\hline
	  ...
	  \hline
	  \mc{Ausgeloggt} & \mc{Account erstellt und eingeloggt} \\
	  \hline
...
\begin{center}
	...
	\hline
	  \textbf{ID} & \textbf{Name} & \textbf{Priorität} & \textbf{Abdeckung} \\
	  \hline
	  TC02 & Freundschafts Anfrage & Hoch & UC02 \\
	  \hline
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, 2. Account bereit (Freund)} & \mc{Anfrage versendet und bestätigt} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
	  ...
	  \mc{ Drawer Menu öffnen -> "Ausloggen" auswählen } & \mc{ Register/Login erscheint } \\
	  \mc{ Mit "Freund" einloggen } & \mc{ Main Screen } \\
	  \mc{ Drawer Menu öffnen -> "Offene Anfragen" auswählen } & \mc{ Liste mit Anfragen erscheint } \\
	  \mc{ Anfrage bestätigen } & \mc{ Zurück auf Hauptbildschirm, Freund wird angezeigt } \\
	  \hline
	\end{tabular}
\end{center}
...
\begin{center}
	...
	\hline
	  \textbf{ID} & \textbf{Name} & \textbf{Priorität} & \textbf{Abdeckung} \\
	  \hline
	  TC03 & Freundschaftsanfrage (Ablehnen) & Mittel & UC02 \\
	  \hline
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, 2. Account bereit (Freund)} & \mc{Anfrage versendet und bestätigt} \\
	  ...
	  \mc{ Mit "Freund" einloggen } & \mc{ Main Screen } \\
	  \mc{ Drawer Menu öffnen -> "Offene Anfragen" auswählen } & \mc{ Liste mit Anfragen erscheint } \\
	  \mc{ Anfrage ablehnen } & \mc{ Zurück auf Hauptbildschirm, Freund wird angezeigt } \\
	  \hline
	\end{tabular}
\end{center}
...
\begin{center}
	...
	\hline
	  ...
	  \mc{ Mit "Freund" einloggen } & \mc{ Main Screen } \\
	  \mc{ Drawer Menu öffnen -> "Offene Anfragen" auswählen } & \mc{ Liste mit Anfragen erscheint } \\
	  \mc{ Anfrage annehmen } & \mc{ Zurück auf Hauptbildschirm, Freund wird nicht angezeigt } \\
	  \hline
	\end{tabular}
\end{center}
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, mind 1 Freund} & \mc{Freundschaft aufgelöst} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, mind 1 Freund} & \mc{Position des Freundes bekannt} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
	  \mc{ Freund aus Liste auswählen } & \mc{Freund Details werden angezeigt} \\
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, mind 1 Freund, Freund hat bekannte Position} & \mc{Proximety Alarm ausgelöst} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, mind 1 Freund} & \mc{E-Mail an Freund gesendet} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
	  \mc{ Freund aus Liste auswählen } & \mc{Freund Details werden angezeigt} \\
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt, mind 1 Freund} & \mc{Einstellungen angepasst} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
	  \mc{ Freund aus Liste auswählen } & \mc{Freund Details werden angezeigt} \\
...
\begin{center}
	...
	\hline
	  ...
	  \mc{\textbf{Vorbedingung}} & \mc{\textbf{Nachbedingung}} \\
	  \hline
	  \mc{Eingeloggt} & \mc{Einstellungen angepasst} \\
	  \hline
	  \mc{\textbf{Schritte}} & \mc{\textbf{Erwartet}} \\
	  \hline
	  ...
	  \mc{ Ausloggen, App schliessen } & \mc{} \\
	  \mc{ App starten, Einloggen } & \mc{Hauptbildschirm erscheint} \\
